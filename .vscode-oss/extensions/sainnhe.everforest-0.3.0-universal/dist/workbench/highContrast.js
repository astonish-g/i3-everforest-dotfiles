...
function highContrastWorkbench(palette, configuration, variant) {
    ...
    const tokens = {
        ...
        "editor.wordHighlightStrongBackground": variant === "dark" ? `${palette.bg4}b0` : `${palette.bg4}90`,
        ...
        "terminal.ansiBlack": variant === "dark" ? `${palette.bg2}` : `${palette.fg}`,
        ...
        "terminal.ansiBrightWhite": variant === "dark" ? `${palette.fg}` : `${palette.bg2}`,
