...
function activate() {
    ...
    vscode_1.workspace.onDidChangeConfiguration((event) => {
        utils.detectConfigChanges(event, () => {
            utils.generate((0, path_1.join)(__dirname, "..", "themes", "everforest-dark.json"), (0, path_1.join)(__dirname, "..", "themes", "everforest-light.json"), utils.getThemeData(utils.getConfiguration()));
        });
    });
